...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 29, 2021 lúc 06:21 PM
...
CREATE TABLE `books` (
  ...
  `book_Category` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `books_add` (`book_title`, `book_author`, `book_image`, `book_descr`) VALUES
('Đồi gió hú', 'Revo', 'img/img_upload/doi-gio-hu-minh-hoa.jpg', 'abc');
...
INSERT INTO `users` (`userid`, `first_name`, `last_name`, `email`, `password`, `registration_date`, `status`, `code`, `avatar`) VALUES
(54, 'Lê Phương', 'Trang', 'lephuongtrang45678@gmail.com', '$2y$10$XpuwGS2nxfH/K2eDf8iXSuIiLpFZqGZNihDhkP5MUiJn9qLcRlZPK', '2021-10-29 16:16:21', 1, 'c4b4f2ea0a68edad3e3707dab8ab6a26', 'img/img_upload/4.jpg');
...
--
ALTER TABLE `users`
  MODIFY `userid` mediumint(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;
<<<<<<< HEAD
...
ALTER TABLE `order_items`
  ...
  ADD CONSTRAINT `order_items_ibfk_3` FOREIGN KEY (`orderid`) REFERENCES `orders` (`orderid`),
  ADD CONSTRAINT `order_items_ibfk_4` FOREIGN KEY (`orderid`) REFERENCES `orders` (`orderid`),
  ADD CONSTRAINT `order_items_ibfk_5` FOREIGN KEY (`orderid`) REFERENCES `orders` (`orderid`),
  ADD CONSTRAINT `order_items_ibfk_6` FOREIGN KEY (`book_isbn`) REFERENCES `books` (`book_isbn`);
=======
>>>>>>> 9ba16c8250ac572bd72be8c63558b929826afb37
COMMIT;
